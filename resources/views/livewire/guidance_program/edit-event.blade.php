            ...
            <form wire:submit='updateEvent()'>
                <div class="modal-body" style="margin-left: 1rem; margin-right: 1rem; max-height: 560px; overflow-y: auto;">
                    ...
                    @if (!$is_public)
                        <div class="row form-group mb-6" style="font-size: 14px; color: #252525;" x-init="initMultiSelect()">
                            <div class="col-12" wire:ignore>
                                <label for="multi-select">Select Users Involve</label>
                                <select class="form-select multiple-select-optgroup-clear-field" data-placeholder="Select Target User(s)" id="multi-select" multiple style="border: 1px solid #252525;">
                                    <option></option>
                    ...
                    <div class="row" style="margin-bottom: 2rem;">
                        <div class="row col-12 d-flex justify-content-start" style="font-size: 18px;">
