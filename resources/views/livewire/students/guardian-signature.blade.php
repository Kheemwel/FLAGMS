                                        ...
                                        <div class="tab-pane active" id="p-draw-mode-tab" wire:ignore.self x-data="signaturePad">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-sm-6 button-container" style="font-size: 12px; color: #252525;">
                                                    <button class="btn btn-block btn-primary" style=" width: 10rem; font-size: 14px; background-color: #0A0863; border: transparent;" type="button"  x-on:click="@this.set('guardianSignature', getContent());">Submit</button>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /.tab-pane -->
