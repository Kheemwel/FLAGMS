<div style="margin-left: 2rem; margin-right: 2rem;">
    <div class="row" style="margin-bottom: 2rem; margin-top: 1rem;">
        ...
        <div class="col-6" style="max-width: 20%;">
            <!--SEARCH INPUT-->
            <input class="form-control float-right" name="table_search" placeholder="Search" style="height: 35px;" type="text" wire:model.live.debounce.500ms='offenses_search'>
        </div>
        <div class="col-6 d-flex justify-content-end ml-auto">
            <!--ADD ROLE BUTTON-->
            <button class="btn btn-default" data-target="#addOffenseModal" data-toggle="modal" style="border-radius: 10px; font-size: 12px; margin-left: 1rem; background-color: #0A0863; color: white;" type="button">
