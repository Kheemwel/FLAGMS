...
<div aria-hidden="true" aria-labelledby="myModalLabel" class="modal fade" id="editOffenseLevelModal" role='dialog' style="max-width: 100%;" wire:ignore.self>
    <div class="modal-dialog">
        <div class="modal-content">
            <div wire:loading wire:target='getOffenseLevel'>
            ...
            <form wire:submit.prevent="updateOffenseLevel()">
                <div class="modal-body" style="margin-left: 1rem; max-height: 500px; overflow-y: auto;">
                    <!--MODAL FORM TITLE-->
                    <p class="card-title" style="color: #0A0863; font-weight: bold; font-size: 22px;">Edit Offense Level</p> <br><br><br>
