                    ...
                    <tbody>
                        @foreach ($anecdotal as $anec)
                            <tr>
                                ...
                                <td wire:click="$set('selectedAnecdotalRow', {{ $anec->id }})" data-toggle="modal" data-target="#student-signature" class="text-center"><img height="150px" src="{{ $anec->student_signature() }}" width="150px"></td>
