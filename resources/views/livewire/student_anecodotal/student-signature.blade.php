<div class="modal fade as-modal signaturePadModal" data-backdrop="static" id="student-signature" role="dialog" style="max-width: 100%;" wire:ignore.self>
                                ...
                                <div class="card-body pl-0 pr-0">
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="draw-mode-tab" wire:ignore.self x-data="signaturePad">
                                            <canvas style="width: 100%; height: 300px; border: 1px solid black" wire:model='studentSignature' x-on:mousedown="startDrawing" x-on:mousemove="draw" x-on:mouseup="stopDrawing" x-on:touchend="stopDrawing" x-on:touchmove="draw" x-on:touchstart="startDrawing" x-ref="canvas"></canvas>
                                            <div class="row">
                                                ...
                                                <div class="form-group col-sm-6 button-container text-sm">
                                                    <button class="btn btn-block btn-primary text-sm border-0" type="submit" x-on:click="@this.set('studentSignature', getContent())">Submit</button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane" id="upload-image-tab" wire:ignore.self>
                                            ...
                                            <div class="form-group col-sm-12 button-container text-sm">
                                                <button class="btn btn-block btn-primary text-sm border-0" type="submit">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.tab-content -->
