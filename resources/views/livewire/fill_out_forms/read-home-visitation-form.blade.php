...
<div class="modal as-modal fade" id="read-home-visitation-form" style="max-width: 100%; overflow-y: auto" wire:ignore.self>
    <div class="modal-dialog as-dialog modal-xl">
        <div class="modal-content" x-on:click.outside="$wire.resetFields()" style="border-radius: 20px;">
            ...
            <form>
                <div class="modal-body" id="home-visitation-form-content" style="margin-left: 1rem; margin-right: 1rem;  text-align: left;">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-5 mb-0" style="font-size: 16px; color: #252525;">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-9 mb-0 text-justify" style="font-size: 16px; color: #252525;">
                            <p style="font-size: 18px; text-decoration: underline;">{{ $homeVisitationFormFields['reason'] }}</p>
                        </div>
                    </div>

                    <div class="row">
                        <div class="form-group col-sm-3 mb-0 text-justify" style=" color: #252525;">
                            <p style="font-size: 18px;">Remarks / Agreement:</p>
                        </div>
                        <div class="form-group col-sm-9 mb-0" style="font-size: 16px; color: #252525;">
                            <p style="font-size: 18px; text-decoration: underline;">{{ $homeVisitationFormFields['remark'] }}</p>
                        </div>
                    </div>

                    <div class="row">
                        <div class="form-group col-sm-6 mb-0" style=" color: #252525; text-align: center; margin-top: 1rem;">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6 mb-0" style=" color: #252525;">
