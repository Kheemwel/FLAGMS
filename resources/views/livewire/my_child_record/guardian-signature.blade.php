    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content" style="border-radius: 20px;">
            ...
            <div class="modal-header p-3 border-0">
                <button aria-label="Close" class="close" type="button" x-on:click="$('#guardian-signature').modal('hide')">
                                ...
                                <div class="card-body pl-0 pr-0">
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="draw-mode-tab" wire:ignore.self x-data="signaturePad">
                                            <canvas style="width: 100%; height: 300px; border: 1px solid black" wire:model='guardianSignature' x-on:mousedown="startDrawing" x-on:mousemove="draw" x-on:mouseup="stopDrawing" x-on:touchend="stopDrawing" x-on:touchmove="draw" x-on:touchstart="startDrawing" x-ref="canvas"></canvas>
                                            <div class="row">
                                                ...
                                                <div class="form-group col-sm-6 button-container text-sm">
                                                    <button class="btn btn-block btn-primary text-sm border-0" type="submit" x-on:click="@this.set('guardianSignature', getContent())">Submit</button>
                                                </div>
                                            </div>
