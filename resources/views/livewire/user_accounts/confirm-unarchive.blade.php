<!--DELETE MODAL-->
<div class="modal fade" id="unArchiveModal" wire:ignore.self>
            ...
            <div class="modal-body" style="margin-left: 1rem; margin-right: 1rem; text-align: center;">
                ...
                <div style="display: flex; flex-direction: column;">
                    <div class="input-group-prepend">
                        ...
                        <button class="btn btn-primary" data-dismiss="modal" style="width: 300px; margin-left: 5px; border-color: #0A0863; background-color: #0A0863; color: white; font-size: 14px;" type="submit" wire:click='unArchive()'>Yes</button>
                    </div>
                </div>
