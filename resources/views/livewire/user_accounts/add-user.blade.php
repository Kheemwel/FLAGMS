...
<div aria-hidden="true"  x-data="{ role: '{{ $role }}' }" aria-labelledby="myModalLabel" class="modal fade" id="addUserModal" role='dialog' style="max-width: 100%;" wire:ignore.self>
    <div class="modal-dialog">
        <div class="modal-content" x-on:click.outside="role = ''">
            ...
            <div class="modal-header" style="border: transparent; padding: 10px;">
                <button aria-label="Close" class="close" data-dismiss="modal" type="button" wire:click="resetInputFields()" x-on:click="role = ''">
            ...
            <div class="modal-body" style="margin-left: 1rem; max-height: 500px; overflow-y: auto;">
                ...
                <div style="display: flex; flex-direction: column;">
                    ...
                    <div class="input-group-prepend">
                        <select required class="form-select form-select-sm mb-2" x-model="role" id="roles" wire:model="role">
                            @if ($role == '')
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6" style="font-size: 14px; color: #252525;">
                        ...
                        <input required maxlength="255" class="form-control" id="inputFN" name='first_name' style="border: 1px solid #252525" type="text" wire:model="first_name">
                        <x-error field="first_name" />
                    </div>
                    <!--LASTNAME-->
                    <div class="form-group col-sm-6" style="font-size: 14px; color: #252525;">
                        <label for="inputLN" style="font-weight: normal;">Last Name</label>
                        <input required maxlength="255" class="form-control" id="inputLN" name='last_name' style="border: 1px solid #252525" type="text" wire:model="last_name">
                ...
                <div class="row">
                    <div class="form-group col-sm-6" style="font-size: 14px; color: #252525;">
                        ...
                        <input required class="form-control" id="inputEmail" name="email" style="border: 1px solid #252525" type="email" wire:model="email">
                        <x-error field="email" />
                    </div>
                </div>
                <!--PASSWORD-->
                <div class="row" x-data="passwordInput">
                    <div class="form-group col-sm-6" style="font-size: 14px; color: #252525;">
                        ...
                        <div class="input-group col-sm-13" style="font-size: 14px; color: #252525; border: 1px solid #252525; border-radius: 5px; padding-right: 5px;">
                            <input required minlength="6" class="form-control" id="input-pass" name="password" placeholder="Password" style="border: none" wire:model="password" x-model="password" x-bind:type="show ? 'text' : 'password'">
