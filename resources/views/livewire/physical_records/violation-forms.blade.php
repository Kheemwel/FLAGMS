                ...
                <div class="card-body table-responsive p-0"style="border: 1px solid #252525; border-radius: 10px;">
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover" style="text-align: center;">
                            ...
                            <tbody>
                                @foreach ($records_violation_forms as $record)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-primary action-btn" data-target="#edit-violation-record" data-toggle="modal" wire:click="getRecord('violation', {{ $record->id }})">
                                                <i class="fa fa-solid fa-pen"></i>
                                            </a>

                                            <!--ANECDOTAL STUDENT INFO VIEW BUTTON-->
                                            <a class="btn btn-primary action-btn" data-target="#view-violation-record" data-toggle="modal" wire:click="getRecord('violation', {{ $record->id }})">
                                                <i aria-hidden="true" class="fa fa-eye"></i>
                                            </a>

                                            <!--DELETE BUTTON-->
                                            <a class="btn btn-primary action-btn" wire:click="deleteRecord('violation', {{ $record->id }})">
...
<!--UPLOAD VIOLATION FORM MODAL-->
<div class="modal fade" id="upload-violation-form" wire:ignore.self>
    <div class="modal-dialog">
        <div class="modal-content" x-data="studentInfo()">
            ...
            <form wire:submit="uploadRecord('violation', studentName, selectedSchoolLevel, selectedGradeLevel, teacherName)">
                <div class="modal-body" style="margin-left: 1rem; max-height: 500px; overflow-y: auto;">
                    <!--MODAL FORM TITLE-->
                    <p class="card-title" style="color: #0A0863; font-weight: bold; font-size: 22px;">Upload Violation Form Record</p> <br><br><br>
...
<!--Edit Modal -->
<div class="modal fade" id="edit-violation-record" wire:ignore.self data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content" x-data="studentInfo()">
            ...
            <form wire:submit="updateRecord('violation', studentName, selectedSchoolLevel, selectedGradeLevel, teacherName)">
                <div class="modal-body" style="margin-left: 1rem; max-height: 500px; overflow-y: auto;">
                    <!--MODAL FORM TITLE-->
                    <p class="card-title" style="color: #0A0863; font-weight: bold; font-size: 22px;">Edit Violation Form Record</p> <br><br><br>
...
<!-- View Modal -->
<div class="modal fade" id="view-violation-record" wire:ignore.self data-backdrop="static">
