        ...
        <div class="col-12">
            <div class="card-tools" style="display: flex; justify-content: flex-end; margin-bottom: 2rem; margin-right: 2rem;">
                ...
                <div class="input-group input-group-sm" style="max-width: 30%;">
                    ...
                    <!--UPLOAD BUTTON-->
                    <button class="btn btn-default" data-target="#upload-hv-form" data-toggle="modal" style="max-width: 5rem; height: 35px; font-size: 12px; margin-left: 1rem; background-color: #0A0863; color: white;" type="button"><i class="fa fa-solid fa-upload"></i> Upload</button>
                ...
                <div class="card-body table-responsive p-0"style="border: 1px solid #252525; border-radius: 10px;">
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover" style="text-align: center;">
                            ...
                            <tbody>
                                @foreach ($records_home_visitation_forms as $record)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-primary action-btn" data-target="#edit-hv-record" data-toggle="modal" wire:click="getRecord('home', {{ $record->id }})">
                                                <i class="fa fa-solid fa-pen"></i>
                                            </a>

                                            <!--ANECDOTAL STUDENT INFO VIEW BUTTON-->
                                            <a class="btn btn-primary action-btn" data-target="#view-hv-record" data-toggle="modal" wire:click="getRecord('home', {{ $record->id }})">
                                                <i aria-hidden="true" class="fa fa-eye"></i>
                                            </a>

                                            <!--DELETE BUTTON-->
                                            <a class="btn btn-primary action-btn" wire:click="deleteRecord('home', {{ $record->id }})">
...
<!--UPLOAD HOME VISITATION FORM MODAL-->
<div class="modal fade" id="upload-hv-form" wire:ignore.self>
    <div class="modal-dialog">
        <div class="modal-content" x-data="studentInfo()">
            ...
            <form wire:submit="uploadRecord('home', studentName, selectedSchoolLevel, selectedGradeLevel, teacherName)">
                <div class="modal-body" style="margin-left: 1rem; max-height: 500px; overflow-y: auto;">
                    <!--MODAL FORM TITLE-->
                    <p class="card-title" style="color: #0A0863; font-weight: bold; font-size: 22px;">Upload Home Visitation Form Record</p> <br><br><br>
                    ...
                    <!--TEACHER'S NAME-->
                    <div class="form-group col-sm-13" style="font-size: 14px; color: #252525; text-align: left;">
                        <label for="upload-hv-teacher-name" style="font-weight: normal;">Teacher's Name</label>
                        <input x-ref="teacherName" x-model="teacherName" class="form-control" id="upload-hv-teacher-name" style="border: 1px solid #252525" type="text">
...
<!--Edit Modal -->
<div class="modal fade" id="edit-hv-record" wire:ignore.self data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content" x-data="studentInfo()">
            ...
            <form wire:submit="updateRecord('home', studentName, selectedSchoolLevel, selectedGradeLevel, teacherName)">
                <div class="modal-body" style="margin-left: 1rem; max-height: 500px; overflow-y: auto;">
                    <!--MODAL FORM TITLE-->
                    <p class="card-title" style="color: #0A0863; font-weight: bold; font-size: 22px;">Edit Home Visitation Form Record</p> <br><br><br>
                    ...
                    <!--TEACHER'S NAME-->
                    <div class="form-group col-sm-13" style="font-size: 14px; color: #252525; text-align: left;">
                        <label for="edit-hv-teacher-name" style="font-weight: normal;">Teacher's Name</label>
                        <input x-ref="teacherName" x-model="teacherName" class="form-control" id="edit-hv-teacher-name" style="border: 1px solid #252525" type="text">
                        <x-error field="teacher_name"/>
                    </div>
...
<!-- View Modal -->
<div class="modal fade" id="view-hv-record" wire:ignore.self data-backdrop="static">
