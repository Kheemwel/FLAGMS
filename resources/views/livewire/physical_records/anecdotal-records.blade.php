        ...
        <div class="col-12">
            <div class="card-tools" style="display: flex; justify-content: flex-end; margin-bottom: 2rem; margin-right: 2rem;">
                ...
                <div class="input-group input-group-sm" style="max-width: 30%;">
                    ...
                    <!--UPLOAD BUTTON-->
                    <button class="btn btn-default" data-target="#upload-anecdotal-form" data-toggle="modal" style="max-width: 5rem; height: 35px; font-size: 12px; margin-left: 2rem; background-color: #0A0863; color: white;" type="button"><i class="fa fa-solid fa-upload"></i> Upload</button>
                ...
                <div class="card-body table-responsive p-0"style="border: 1px solid #252525; border-radius: 10px;">
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover" style="text-align: center;">
                            ...
                            <tbody>
                                @foreach ($records_anecdotal as $record)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-primary action-btn" data-target="#edit-anecdotal-record" data-toggle="modal" wire:click="getRecord('anecdotal', {{ $record->id }})">
                                                <i class="fa fa-solid fa-pen"></i>
                                            </a>

                                            <!--ANECDOTAL STUDENT INFO VIEW BUTTON-->
                                            <a class="btn btn-primary action-btn" data-target="#view-anecdotal-record" data-toggle="modal" wire:click="getRecord('anecdotal', {{ $record->id }})">
                                                <i aria-hidden="true" class="fa fa-eye"></i>
                                            </a>

                                            <!--DELETE BUTTON-->
                                            <a class="btn btn-primary action-btn" wire:click="deleteRecord('anecdotal', {{ $record->id }})">
...
<!-- Upload Modal -->
<div class="modal fade" id="upload-anecdotal-form" wire:ignore.self>
    <div class="modal-dialog">
        <div class="modal-content" x-data="studentInfo()">
            ...
            <form wire:submit="uploadRecord('anecdotal', studentName, selectedSchoolLevel, selectedGradeLevel, teacherName)">
                <div class="modal-body" style="margin-left: 1rem; max-height: 500px; overflow-y: auto;">
                    ...
                    <div class="form-group col-sm-13" style="font-size: 14px; color: #252525; text-align: left;">
                        <label for="upload-anec-student-name" style="font-weight: normal;">Student Name</label>
                        <input x-ref="studentName" class="form-control auto-complete" id="upload-anec-student-name" required style="border: 1px solid #252525" type="text" x-model='studentName'>
...
<!--Edit Modal -->
<div class="modal fade" id="edit-anecdotal-record" wire:ignore.self data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content" x-data="studentInfo()">
            ...
            <form wire:submit="updateRecord('anecdotal', studentName, selectedSchoolLevel, selectedGradeLevel, teacherName)">
                <div class="modal-body" style="margin-left: 1rem; max-height: 500px; overflow-y: auto;">
                    <!--MODAL FORM TITLE-->
                    <p class="card-title" style="color: #0A0863; font-weight: bold; font-size: 22px;">Edit Anecdotal Record</p> <br><br><br>

                    <!--IMPORTANT USER DETAILS FORM SECTION-->
                    <!--------------------USER'S INFORMATION------------------------>
                    <!--STUDENT NAME-->
                    <div class="form-group col-sm-13" style="font-size: 14px; color: #252525; text-align: left;">
                        <label for="edit-anec-student-name" style="font-weight: normal;">Student Name</label>
                        <input x-ref="studentName" class="form-control auto-complete" id="edit-anec-student-name" required style="border: 1px solid #252525" type="text" x-model='studentName'>
                        <x-error field="student_name" />
                    </div>
...
<!-- View Modal -->
<div class="modal fade" id="view-anecdotal-record" wire:ignore.self data-backdrop="static">
