    ...
    <div class="card card-primary card-tabs" style="background-color:  rgb(253, 253, 253);margin-left: 2rem; margin-right: 2rem;">
        ...
        <div class="card-body">
            <div class="tab-content" id="custom-tabs-one-tabContent" style="padding-right: 2rem;">
                <div wire:ignore.self aria-labelledby="custom-tabs-one-offense-tab" class="tab-pane fade active show" id="custom-tabs-one-found-items" role="tabpanel">
                    @include("livewire.lost_and_found.found-items-table")
                </div>
                <div wire:ignore.self aria-labelledby="custom-tabs-one-claimed-items-tab" class="tab-pane fade" id="custom-tabs-one-claimed-items" role="tabpanel">
