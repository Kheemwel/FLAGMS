...
<head>
    ...
    <title>Student | Individual Inventory</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="background-color:  rgb(253, 253, 253); padding-left: 2rem;">
            ...
            <div class="form-group col-sm-12" style="padding-top: 10rem; padding-bottom: 10rem; display: flex; flex-direction: column; align-items: center;">
                <div>
                    <label style="color: #252525; font-size: 14px; font-weight: normal; text-align: center;">You have not yet submitted your <br> individual inventory report </label>
                </div>
                <div>
                    <a class="btn btn-block btn-primary" href="{{ route('student-individual-inventory-report-page') }}" style=" width: 8rem; font-size: 12px; background-color: #0A0863; border: transparent;" type="button">Create Report</a>
                </div>
            </div>
        </div>
    </div>
