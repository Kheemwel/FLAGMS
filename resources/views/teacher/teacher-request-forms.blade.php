...
<head>
    ...
    <title>Teacher | Request Forms</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="card-tools" style="display: flex; justify-content: flex-end; margin-bottom: 2rem; margin-right: 2rem;">
                        ...
                        <div class="input-group input-group-sm" style="max-width: 30%;">
                            ...
                            <div class="input-group-append">
                                ...
                                <button class="btn btn-block btn-default" style="border-color: transparent; background-color: #0A0863; color: #252525; color:white; margin-left: 2rem;">Request Form</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="small-box bg-info" style="background-color: white !important; color: #252525 !important; box-shadow: 0 0 10px rgba(0, 0, 0, 0.5); border-radius: 10px; display: flex; flex-direction: row;">
                            <table cellpadding="20px" cellspacing="10px" style="width: 100%;">
                                ...
                                <td style="vertical-align: bottom; float: right; width: 100%;">
                                    <button class="btn btn-default" data-target="#form-filler-vf" data-toggle="modal" style="float: right;color: white; background-color: #080743; font-size: 14px; width: 120px; margin-left: 1rem;">Set Form Filler</button>
    ...
    <!--VIOLATION SET FORM FILLER MODAL-->
    <div class="modal fade" id="form-filler-vf">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="border: transparent; padding: 10px;">
                    <button aria-label="Close" class="close" data-dismiss="modal" type="button">
                ...
                <form>
                    <div class="modal-body" style="max-height: 500px; overflow-y: auto; margin-left: 1rem; margin-right: 1rem;">
                        <!--MODAL FORM TITLE-->
                        <p class="card-title" style="color: #080743; font-size: 20px; font-weight: bold;">Violation Form</p> <br><br>
                        <!--IMPORTANT USER DETAILS FORM SECTION-->
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <p class="card-title" style="color: #080743; font-size: 16px; font-weight: bold;">Enter the name of recipients</p>
                            </div>
                        </div>

                        <div class="row">
                            <div class="form-group col-sm-12">
                                <p class="card-title" style="color: #252525; font-size: 16px; font-weight: bold;">Name of Student</p>
                                <input class="form-control" name="std-name" style="border-color: #252525;" type="text">
                            </div>
                        </div>

                        <div class="row">
                            <div class="form-group col-sm-12">
                                <p class="card-title" style="color: #252525; font-size: 16px; font-weight: bold;">Guidance Associate</p>
                                <input class="form-control" name="guidance-associate-nm" style="border-color: #252525;" type="text">
                            </div>
                        </div>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-10 offset-md-1 text-center">
                                <button class="btn btn-block btn-default" style="border-color: transparent; background-color: #0A0863; color: #252525; color:white;">Send</button>
                            </div>
                        </div>
                    </div> <!-- /.modal-body -->
                </form>
    ...
    <!--HOME VISITATION SET FORM FILLER MODAL-->
    <div class="modal fade" id="form-filler-hv">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="border: transparent; padding: 10px;">
                    <button aria-label="Close" class="close" data-dismiss="modal" type="button">
                ...
                <form>
                    <div class="modal-body" style="max-height: 500px; overflow-y: auto; margin-left: 1rem; margin-right: 1rem;">
                        <!--MODAL FORM TITLE-->
                        <p class="card-title" style="color: #080743; font-size: 20px; font-weight: bold;">Home Visitation Form</p> <br><br>
                        <!--IMPORTANT USER DETAILS FORM SECTION-->
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <p class="card-title" style="color: #080743; font-size: 16px; font-weight: bold;">Enter the name of recipients</p>
            ...
            <div class="modal-content">
                ...
                <form>
                    <div class="modal-body" style="max-height: 500px; overflow-y: auto; margin-left: 1rem; margin-right: 1rem;">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <p class="card-title" style="color: #252525; font-size: 16px; font-weight: bold;">Type of Form</p>
                            </div>
                        </div>

                        <div class="row">
                            <div class="form-group col-sm-12">
                                <button class="btn dropdown-menu" style="border-color: transparent; background-color: #0A0863; color: #252525; color:white;">Request Form</button>
                            </div>
                        </div>
