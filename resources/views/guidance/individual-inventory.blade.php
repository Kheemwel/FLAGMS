...
<head>
    ...
    <title>Admin | Individual Inventory</title>
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6" style="padding-left: 2rem; padding-top: 1rem;">
                            <h1 style="font-weight: bold;">Individual Inventory</h1>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                ...
                <div class="col-12">
                    <div class="card-tools" style="display: flex; justify-content: flex-end; margin-bottom: 2rem; margin-right: 2rem;">
                        ...
                        <div class="input-group input-group-sm" style="max-width: 30%;">
                            ...
                            <div class="modal fade" id="upload-inventory-form">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header" style="border: transparent; padding: 10px;">
                                            <button aria-label="Close" class="close" data-dismiss="modal" type="button">
                                        ...
                                        <form>
                                            <div class="modal-body" style="margin-left: 1rem; max-height: 500px; overflow-y: auto;">
                                                <!--MODAL FORM TITLE-->
                                                <p class="card-title" style="color: #0A0863; font-weight: bold; font-size: 22px;">Upload Individual Inventory</p> <br><br><br>
                    ...
                    <table class="table text-nowrap" style="text-align: center;">
                        <thead style="background-color: #7684B9; color: white;">
                            <tr>
                                ...
                                <th style="border-right: 1px solid #252525;">Date Submitted</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td>12/08/23</td>
                                <td>
                                    <!--INDIVIDUAL INVENTORY STUDENT INFO EDIT BUTTON-->
