                            ...
                            <div class="sticky-top mb-3">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Pending Draggable Events</h4>
                                    </div>
                                    <div class="card-body">
                                        <!-- the events -->
                                        <div id="external-events">
                                            <div class="external-event" style="background-color: #FC993E;">Seminar</div>
                                            <div class="external-event" style="background-color: #3EA1FC;">Faculty Meeting</div>
                                            <div class="external-event" style="background-color: #6256AC;">Mental Awareness</div>
                                            <div class="external-event" style="background-color: #05ADC7;">Job Hunting</div>
                                            <div class="external-event" style="background-color: #FA4481;">Student Organization</div>
                                            <div class="checkbox">
                                    ...
                                    <div class="card-body">
                                        <div class="btn-group" style="width: 100%; margin-bottom: 10px;">
                                            <ul class="fc-color-picker" id="color-chooser">
                                                <li><a href="#"><i class="fas fa-square" style="color: #FC993E;"></i></a></li>
                                                <li><a href="#"><i class="fas fa-square" style="color: #3EA1FC;"></i></a></li>
                                                <li><a href="#"><i class="fas fa-square" style="color: #6256AC;"></i></a></li>
                                                <li><a href="#"><i class="fas fa-square" style="color: #05ADC7;"></i></a></li>
                                                <li><a href="#"><i class="fas fa-square" style="color: #FA4481;"></i></a></li>
                                            </ul>
                                        </div>
                                        <!-- /btn-group -->
                                        <div class="input-group">
                                            <input class="form-control" id="new-event" placeholder="Event Title" type="text">

                                            <div class="input-group-append">
                                                <button class="btn btn-primary" id="add-new-event" style="background-color: #060554; border-color: transparent;" type="button">Add</button>
                                            </div>
                                            <!-- /btn-group -->
                                        </div>
                                        <!-- /input-group -->
